...
class ProductController extends Controller
{
    ...
    public function saveProductImages(Request $request ){
        ...
        $filename = savePhoto('products', $file);
    ...
    //TESTING MAY BE USEFUL FOR FUTUER PROJECT
    public function stores(Request $request)
    {
        ...
        //$path= savePhoto('products',$imageName);
        $path = $request->file('file')->storeAs('products',   $imageName);
