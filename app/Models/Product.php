...
{
    use Translatable,
        SoftDeletes; //to make a flag in db if a product is deleted
    ...
    {
        return $this->belongsTo(Brand::class)->withDefault(); //if product does have brand it wont through exception
    }
